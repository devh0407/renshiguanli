...
<option value="出差"  >出差</option>
    ...
    <TD align="center"> 
   <INPUT   onclick="javascript:fPopCalendar(starttime,starttime); return false;"  id="starttime" name=riqi size="30" readonly="readonly" /> 
    ...
    <TD align="center">  
    <input  type="text" name="kouqian"  id='kouqianid'  size="30"  />
