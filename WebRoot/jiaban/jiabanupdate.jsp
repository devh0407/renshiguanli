...
<TABLE class=".table-bordered" cellSpacing=0 cellPadding=0 width="60%" align=center border=1>
    ...
    <TD align="center"> 
    <input  type="text" name="jiabanjihua"  id='jiabanjihuaid'  size="30" value="${bean.jiabanjihua }" />
    ...
    <TD align="center">  
    <input  type="text" name="jiabanshichang"  id='jiabanshichangid'  size="30" value="${bean.jiabanshichang }" />
    ...
    <TD align="center">  
    <input  type="text" name="jiabandidian"  id='jiabandidianid'  size="30" value="${bean.jiabandidian }" />
    ...
    <TD align="center">  
    <textarea rows="7" cols="50" name="jiabanneirong"  id='jiabanneirongid'>${bean.jiabanneirong }</textarea>
