...
<TABLE class=".table-bordered" cellSpacing=0 cellPadding=0 width="60%" align=center border=1>
  	...
  	<TR height=>
    <TD align="center" >加班员工：</TD>
    <TD align="center">  
    <select name="user">
<c:forEach items="${userlist}" var="bean2">
<option value="${bean2.id }"  >${bean2.truename }</option>
</c:forEach>
</select>
    ...
    <TD align="center"> 
    <input  type="text" name="jiabanjihua"  id='jiabanjihuaid'  size="30"  />
    ...
    <TD align="center">  
    <input  type="text" name="jiabanshichang"  id='jiabanshichang'  size="30"  />
    ...
    <TD align="center">  
    <input  type="text" name="jiabandidian"  id='jiabandidianid'  size="30"  />
    ...
    <TD align="center">  
    <textarea rows="7" cols="50" name="jiabanneirong"  id='jiabanneirongid'></textarea>
