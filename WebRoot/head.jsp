...
<style type="text/css">
body {background: #4fa0ff; font-family:Arial, Helvetica, sans-serif; font-size:12px; margin:0px; margin-bottom:2px;border-bottom: 1px #ccc solid;}
h1 {color: #FFF;}
...
<div id="all">
    ...
    <div id="main">
    	<div id="welcome">欢迎你回来,${user.username } <img src="images/clock.gif" /></div>
        <div id="adminop">
            <ul>
                <li><a href="index.jsp" target="_top">站点首页</a></li>
                <li><a href="method!changepwd" target="main">修改密码</a></li>
                <li><a href="method!loginout" target="_top">退出管理</a></li>
